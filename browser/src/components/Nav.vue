<template>
  <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      <a href="#" class="flex">
        <img class="w-8 h-8" :src="logo" alt="Vue">
      </a>
      <div class="flex items-center md:order-2">
        ...
        <button type="button" class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
...
export default {
  ...
  props: {
    name: {
      type: String,
      required: false,
      default: "Wesley Flôres"
    },
    email: {
      type: String,
      required: false,
      default: "wesleyfloresterres@gmail.com"
    },
    logo: {
      type: String,
      required: false,
      default: "https://raw.githubusercontent.com/MagicalStrangeQuark/MagicalStrangeQuark/master/assets/laravel.svg"
    },
    avatar: {
      type: String,
      required: false,
      default: "https://avatars.githubusercontent.com/u/49111142?v=4"
    }
  }
}
</script>
