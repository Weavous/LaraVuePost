...
class CommentControllerTest extends TestCase
{
     ...
     * @return void
     */
    public function test_it_should_store_a_creply_and_return_http_created_status_code()
    {
     ...
     * @return void
     */
    public function test_it_should_store_a_comment_on_post_and_return_http_created_status_code()
    {
